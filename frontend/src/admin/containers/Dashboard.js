    ...
    if (user && user.rating) {
      if (
        ...
        setRatingAttendance({
          ...ratingAttendance,
          series: [
            {name: 'Посещено', data: user?.rating?.attendances_count},
            {name: 'Пропущено', data: user?.rating?.schedule_count - user?.rating?.attendances_count},
          ],
      ...
      if (
        ...
        setRatingAttendance({
          ...ratingAttendance,
          series: [
            {name: 'Сдано', data: user?.rating?.completed_checkpoints},
            {name: 'Провалено', data: user?.rating?.checkpoints_count - user?.rating?.completed_checkpoints},
          ],
      ...
      if (
        ...
        setRatingAttendance({
          ...ratingAttendance,
          series: [
            {name: 'Выполнено', data: user?.rating?.solutions_count},
            {name: 'Не выполнено', data: user?.rating?.tasks_count - user?.rating?.solutions_count},
          ],
          ...
          <div className='main-body__cards'>
            ...
            <div className='cards'>
              ...
              <div className='cards'>
                ...
                {user?.is_student &&
                  user?.schedule_for_today?.map(item => (
                    <div className='today-schedule-wrapper'>
                      <div className='event-row'>
                        <div>
                          {item.start_date ? getTime(item.start_date) : ''}
