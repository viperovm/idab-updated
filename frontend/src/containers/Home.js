...
import {load_home_testimonials, load_home_faq, load_home_dates} from '../redux/actions/home';
import {load_events} from '../redux/actions/events';

const Home = ({load_home_testimonials, load_home_faq, load_events, load_home_dates}) => {
...
export default connect(null, {load_home_testimonials, load_events, load_home_faq, load_home_dates})(Home);