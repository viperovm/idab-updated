        ...
        <MDBCard className='p-5'>
          <MDBCardBody>
            ...
            <p className='text-idab font-weight-bolder'>
              Поступив на программы в ИДАБ, вы совершите правильный выбор, который на долгие годы определит успех
            ...
            <p>
              <span className='text-idab font-weight-bolder'>Выбирайте МВА, приходите в ИДАБ</span>.
            </p>
          </MDBCardBody>
